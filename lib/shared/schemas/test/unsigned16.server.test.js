...
var expect = require('expect.js'),
    ...
    schema = jsvAndSchemas.schemas['unsigned16.json'];

suite('#json.schemas.unsigned16', function () {

    test('valid', function () {
        var result = env.validate(5, schema);
    ...
    test('above max', function () {
        helper.assertSingleNonPropertyFailure(env, 99999, schema, "#", "maximum");
    });
